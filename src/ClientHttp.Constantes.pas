...
type
  TMetodo = (mGET, mPOST, mPUT, mPatch, mDelete);
...
const
  ...
  // Flags para WinHttpOpen
  WINHTTP_FLAG_ASYNC = $10000000;

  // Flags para WinHttpOpenRequest
  ...
  // WinHttpOpenRequest prettifiers
  WINHTTP_NO_REFERER = nil;
  WINHTTP_DEFAULT_ACCEPT_TYPES = nil;

  // WinHttpSendRequest prettifiers
  ...
  // Flags for CrackUrl e CombineUrl
  ...
  // Options para WinHttpQueryOption/WinHttpSetOption
  ...
  // Manifest value for max connections
  WINHTTP_CONNS_PER_SERVER_UNLIMITED = $FFFFFFFF;

  // Values for autologon policy
  ...
  // WinHttpQueryHeaders info levels
  ...
  // Flags for WinHttpAddRequestHeaders
